<?php
$catgory_id = (isset($_GET['cat_id']))?$_GET['cat_id']:'';
$getCatProd = $Product->getCatProd($catgory_id);
shuffle($getCatProd);
//request method post
...
<section id="special-price" class="py-3">
  <div class="container">
    <h4 class="font-rubik font-size-20"><?=$Category->getParentChild($catgory_id);?></h4>
